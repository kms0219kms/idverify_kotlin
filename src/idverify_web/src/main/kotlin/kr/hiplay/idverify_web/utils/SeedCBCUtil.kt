...
object KISA_SEED_CBC {
    ...
    private fun KISA_SEED_Encrypt_Block_forCBC(
        `in`: IntArray, in_offset: Int, out: IntArray, out_offset: Int, ks: KISA_SEED_KEY
    ) {
    ...
    fun SEED_CBC_init(
        ...
        K[30] = SS0[GetB0(T[0]).toInt() and 0x0ff] xor SS1[GetB1(
            T[0]
                ...
                SS2[GetB2(T[0]).toInt() and 0x0ff] xor SS3[GetB3(
            T[0]
        ).toInt() and 0x0ff]
        // K_16,1
        K[31] = SS0[GetB0(T[1]).toInt() and 0x0ff] xor SS1[GetB1(
            T[1]
                ...
                SS2[GetB2(T[1]).toInt() and 0x0ff] xor SS3[GetB3(
            T[1]
        ).toInt() and 0x0ff]
